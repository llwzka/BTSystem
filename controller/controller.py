        ...
        if self.begin_date == ' ' and self.end_date == ' ':
            ...
            for sc in self.strategies_vec:
                ...
                for st in self.strategies_vec[sc]:
                    ...
                    self.contract_info = quoter.Quoter(self.path).read_contract_info(st.strategy_contract(),
                                                                                     st.strategy_name())
                    ...
                    # 生成策略需要的测试信息
                    test_info = datastruct.TestInfo(st.strategy_contract(), st.strategy_contract_cycle_unit(),
                                                    st.strategy_contract_cycle(), self.begin_date, self.end_date)
